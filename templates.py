...
BOT_SIGNATURE_TEMPLATE = """\
  ...
  ^(Issues/feedback are welcome by posting on) [^(r/ringon)](https://www.reddit.com/r/ringon) ^(or by) [^(PM to my maintainer)](https://www.reddit.com/message/compose/?to=Zuiran)
"""
